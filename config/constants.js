...
const GUEST_TABLES = [
  ...
  { name: "Morondava", description: "La route des baobabs face à l'océan", order: 5 },
  { name: "Andasibe", description: "La forêt tropicale et ses lémuriens", order: 6 },
  { name: "Fianarantsoa", description: "Les hautes terres et les vignobles", order: 7 },
