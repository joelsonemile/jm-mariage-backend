...
router.put("/reservations/:id/status", adminController.setReservationStatus);
...
router.put("/commissions/:id/responsables", adminController.setCommissionResponsables);
